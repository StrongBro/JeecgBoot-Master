<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="800" @ok="handleSubmit">
    <testing-instrument-form ref="formComponent" :formDisabled="formDisabled" :formBpm="false" @success="submitSuccess"></testing-instrument-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import TestingInstrumentForm from './TestingInstrumentForm.vue';

  export default {
    name: "TestCgMainVxeModal",
    components:{
      BasicModal,
      TestingInstrumentForm
    },
